...
void RCSwitch::send(unsigned long code, unsigned int length) {
...
#if not defined( RCSwitchDisableReeceiving )
  ...
  //The interrupts has to be disabled for sending the data. Otherwise the transfer time is not correct.
  //Added by Andre E. on 05.05.2020.
  noInterrupts();
  ...
  //Enable all interrupts. Added by Andre E. on 05.05.2020
  interrupts();
